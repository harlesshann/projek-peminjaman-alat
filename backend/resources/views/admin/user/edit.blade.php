        ...
        <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @if($user->foto_profile)
                    <div class="mb-2">
                        <img src="{{ asset($user->foto_profile) }}" alt="Foto Profile"
                            class="w-24 h-24 object-cover rounded-full border-2 border-gray-300">
                    </div>
                @else
                    <div class="mb-2">
                        <span class="inline-flex w-24 h-24 rounded-full bg-gray-300 items-center justify-center text-white font-bold text-2xl border-2 border-gray-300">
