...
@section('content')
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 mb-5">
        ...
        <form action="{{ route('petugas.laporan.index') }}" method="GET" class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
