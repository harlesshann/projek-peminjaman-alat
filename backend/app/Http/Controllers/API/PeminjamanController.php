...
class PeminjamanController extends Controller
{
        ...
        try {
            $peminjaman = DB::transaction(function () use ($request) {
                ...
                foreach ($request->items as $item) {
                    // lockForUpdate mengunci baris data di database sampai transaksi ini selesai
            ...
            return response()->json([
                ...
                'data' => new PeminjamanResource($peminjaman) // Di-optimize menggunakan Resource
            ], 201);
    ...
    public function show(Peminjaman $peminjaman): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => new PeminjamanResource($peminjaman->load(['user',
            'detailPinjams.alat', 'pengembalian']))
        ]);
    }
